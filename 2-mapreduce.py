...
if __name__ == "__main__":
    filename = input("Enter the file path: ")   #paste the path of freq.txt, after running the code 
    target_word = input("Enter the word to find frequency: ")  #enter any word fro freq.txt
    main(filename, target_word)


# need to  create one  file 